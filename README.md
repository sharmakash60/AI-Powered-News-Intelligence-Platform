...
An end-to-end news intelligence platform that fetches real-time articles, processes them with Gemini AI, and surfaces actionable insights through a polished dashboard.

![Stack](https://img.shields.io/badge/Backend-FastAPI-009688?style=flat-square)
![Stack](https://img.shields.io/badge/Database-MongoDB-47A248?style=flat-square)
![Stack](https://img.shields.io/badge/AI-Gemini%202.0%20Flash-4285F4?style=flat-square)
...
- **AI Summarization** — 1–2 sentence summaries per article via Gemini AI- **Sentiment Analysis** — Positive / Negative / Neutral classification with numeric score
...
| AI        | Google Gemini 2.0 Flash  | Fast AI summarization, sentiment analysis, and insight generation |
...
3. Process each article with Gemini AI (summary, sentiment, insights)
---
...
│   ├── ai_processor.py   # Gemini AI summarization & analysis
